            ...
            setTimeout(function() {
                ...
                if (xwikiIGraphImages.length > 0 || containsMediawikiIGraph) {
                    ...
                    require(['portalwiki'], function() {
                        // Since we're able to load portalwiki.min.js and monitorportal.js, we can hide the redirect message
                        // For more information see https://issues.amazon.com/issues/KTC-19182
                        $('.iGraph-default-view').hide();
                        
                        // portalwiki redefines String.prototype.capitalize to something incompatible with prototype.js.
                        // Here we redefine it back to be compatible.
                        String.prototype.capitalize = function () {
                            // Force the first letter to be capital, the rest is lowercase.
