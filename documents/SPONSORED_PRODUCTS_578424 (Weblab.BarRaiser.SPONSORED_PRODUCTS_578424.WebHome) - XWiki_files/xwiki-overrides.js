...
var XWiki = (function(XWiki) {
  ...
  Object.extend(XWiki, {
    ...
    createPermalinkButton: function() {
      ...
      permalinkButton.href = "#"; // For accessibility, to correctly identify this as a navigable link
        ...
        element.addEventListener('click', function(event) {
            ...
            // interaction parameters
            {
              confirmationText: "<strong>Full URL</strong><br/>Link to this section: " +
                                ...
                                "value='" +
                                fullURL +
                                "' autofocus/><span class='input-group-btn'><button type='button' class='btn btn-primary' " +
