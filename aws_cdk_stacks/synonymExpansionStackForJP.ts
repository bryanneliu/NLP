...
const JobName = 'SynonymExpansionStackForJP';
...
export class SynonymExpansionForJPEmrStack extends DeploymentStack {
            ...
            tasks: [
                ...
                },
                {
                    ...
                    args: [
                        ...
                        `${pyScriptBasePath}/synonym_expansion/jp/9_merge_expansions.py`,
                        '--marketplace_id',
                        `\${marketplaceId}`,
                        '--solr_index_latest_ds',
                        `\${solr_index_latest_ds}`
                ...
                },
                {
                    ...
                    args: [
                        ...
                        '--py-files',
                        `${pyScriptBasePath}/utils/marketplace_utils.py,${pyScriptBasePath}/synonym_expansion/commons/utils.py,${pyScriptBasePath}/synonym_expansion/commons/expansion_udf.py`,
                        `${pyScriptBasePath}/synonym_expansion/jp/10_calculate_output_distribution.py`,
                        '--marketplace_id',
                        `\${marketplaceId}`,
                        '--solr_index_latest_ds',
                        `\${solr_index_latest_ds}`
