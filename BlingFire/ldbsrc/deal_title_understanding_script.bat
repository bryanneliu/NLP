...
@REM
@REM SG_LDBSRC_DIR:         path to SearchGold\deploy\builds\data\IndexGenData\ldbsrc
@REM
@REM
@REM **************************************
...
rmdir /S /Q  ldb\deal\deal_title_understanding
...
mkdir ldb\deal\deal_title_understanding
...
nmake -f Makefile.nmake lang=deal\deal_title_understanding mode=morph clean
nmake -f Makefile.nmake lang=deal\deal_title_understanding clean

nmake -f Makefile.nmake lang=deal\deal_title_understanding mode=morph all
nmake -f Makefile.nmake lang=deal\deal_title_understanding all
